export const mockMAndAData = [
  {
    ...
    snippet: 'In a bold move to consolidate the enterprise CRM space, Acme Corp announced the acquisition of Zenith Tech...',
  ...
  },
  {
    ...
    snippet: 'Nexus Data is expanding its portfolio into cybersecurity by picking up ShieldX in a quiet $50M deal.',
...
export const mockSubredditPainData = [
  {
    ...
    postContent: 'Since the acquisition rumors started, Zenith Tech removed their middle tier and forced everyone onto enterprise. Our bill went up 3x. Looking for alternatives.',
...
export const mockNegativeSpaceData = [
  {
    ...
    details: 'Removed "Pro" tier ($99/mo). Lowest available is now "Enterprise" ($499/mo).',
