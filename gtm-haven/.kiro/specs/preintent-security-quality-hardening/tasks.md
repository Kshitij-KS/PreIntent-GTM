...
- [x] 2. Correlation and structured logging primitives
  ...
  - [x]* 2.3 Write property test for logger redaction
    - **Property 4: Secret and PII values are redacted in logs**
    - **Validates: Requirements 3.6, 8.6**

  - [x]* 2.4 Write property test for log record completeness
    - **Property 15: Log records are structurally complete**
    - **Validates: Requirements 8.3**

  - [x]* 2.5 Write property test for single correlation id per request
    - **Property 16: One correlation id per request**
    - **Validates: Requirements 8.4**

  - [x]* 2.6 Write property test for log level suppression
...
- [x] 6. Auth guard
  ...
  - [x]* 6.2 Write example unit tests for auth guard
...
- [x] 7. Rate limiter
  ...
  - [x]* 7.2 Write property test for rate-limit window enforcement
    - **Property 10: Rate-limit window enforcement**
    - **Validates: Requirements 6.1, 6.2, 6.4**

  - [x]* 7.3 Write property test for budget independence
    - **Property 11: Rate-limit budgets are independent per caller and per endpoint**
    - **Validates: Requirements 6.3, 6.5**

- [x] 8. Response validator
  - [x] 8.1 Implement response validator
  ...
  - [x]* 8.2 Write property test for response round-trip identity
    - **Property 8: Response_Validator round-trip identity**
    - **Validates: Requirements 5.1, 5.7, 10.4**

  - [x]* 8.3 Write property test for non-conforming fallback
    - **Property 9: Non-conforming responses fall back without mutating state**
    - **Validates: Requirements 5.2, 5.5**

- [x] 9. Compose guards wrapper
  - [x] 9.1 Implement withGuards composition
  ...
  - [x]* 9.2 Write unit tests for guard ordering and wiring
...
- [x] 10. Checkpoint - security primitives complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 11. Harden Cognee localStorage persistence
  - [x] 11.1 Harden cognee store read/write paths
  ...
  - [x]* 11.2 Write property test for Cognee round-trip
  ...
  - [x]* 11.3 Write property test for safe discard on load
    - **Property 13: Cognee load discards invalid data safely**
    - **Validates: Requirements 7.1, 7.2, 7.3, 7.4**

  - [x]* 11.4 Write property test for conformant-only writes
    - **Property 14: Cognee write persists only conformant records**
    - **Validates: Requirements 7.6**

  - [x]* 11.5 Write edge-case test for record-count boundary
    - Assert 10,000 records load, 10,001 discard to empty set
    - _Requirements: 7.4_

- [x] 12. Harden integration status reporting
  - [x] 12.1 Tighten integration status to presence-only booleans
  ...
  - [x]* 12.2 Write property test for status secret non-leak
    - **Property 3: Integration status never leaks secret values**
    - **Validates: Requirements 3.3, 3.4**

  - [x]* 12.3 Write example test for real-mode mock fallback
    - A real-mode adapter missing its key returns mock data without exposing any secret value
    - _Requirements: 3.5_

- [x] 13. Refactor routes to compose the security primitives
  - [x] 13.1 Refactor POST /api/sweep route
  ...
  - [x] 13.2 Refactor POST /api/competitors/resolve route
  ...
  - [x] 13.3 Refactor POST /api/command-center route
  ...
  - [x] 13.4 Confirm public endpoints bypass auth guards
  ...
  - [x] 13.5 Rewrite POST /api/onboarding/profile route
  ...
  - [x] 13.6 Harden actions.ts external/model response handling
  ...
  - [x]* 13.7 Write route-level example unit tests
...
- [x] 14. Convergence score property coverage
  - [x]* 14.1 Write property test for convergence range invariant
...
- [x] 15. Final checkpoint - tooling and full suite
